...
export function registerAiCopilotPlugin(aiPanelComponent: unknown) {
    registerPlugin({
        ...
        name: 'AI 코파일럿',
        version: '2.2.0',
        description: 'PDF 편집, 코드 작성, 웹 검색을 보조하는 AI 채팅 플러그인. Gemini(3.8 Flash·3.1 Pro) / GPT-5.6(Sol·Terra·Luna) / Claude(Opus 5·Sonnet 5) / FactChat(금오공대 AI 게이트웨이) 등 최신 모델을 지원합니다.',
